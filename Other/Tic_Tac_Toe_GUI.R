...
# Event Handler that Looks for Action in locator()
...
# Draws an X or and O depending on user
...
# Checks if user has finished (win/loss) the game
...
# Function to pull together the functions and play 
play_game <- function(){
  board <<- matrix(rep(0,9),nrow =3)
  layout_board()
  do_play()
